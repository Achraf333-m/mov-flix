...
function Footer() {
  return (
    <div className="h-80 flex flex-col space-y-8 items-center justify-center">
      ...
      <h3 className="text-xs text-green-400">*****This is simply a project I made to showcase my skills in web development, it is not a real app and the payment page only accepts "test" credit cards*****</h3>
    </div>
  );
}
